...
const kTitle = Text('BMI CALCULATOR');

const kLabelTextStyle = TextStyle(color: kInactiveTextColor, fontSize: 18.0);
const kHeavyTextStyle = TextStyle(fontSize: 50.0, fontWeight: FontWeight.w900);
